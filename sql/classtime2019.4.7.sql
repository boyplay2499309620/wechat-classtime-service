...
CREATE TABLE `phone_model` (
  ...
  `brands` varchar(50) DEFAULT NULL COMMENT '设备品牌',
  `models` varchar(50) DEFAULT NULL COMMENT '设备型号',
  `wechat_languages` varchar(50) DEFAULT NULL COMMENT '微信设置的语言',
  `wechat_version` varchar(50) DEFAULT NULL COMMENT '微信版本号',
  `phone_system` varchar(50) DEFAULT NULL COMMENT '操作系统及其版本',
  `wechat_platform` varchar(50) DEFAULT NULL COMMENT '客户端平台',
...
CREATE TABLE `time` (
  ...
  `times` int(10) DEFAULT NULL COMMENT '保存时间记录，以秒为单位',
...
-- 务必插入的两条语句
INSERT INTO `room` VALUES ('1', '1', '1605010310', '1', '0', '系统测试房间', '0000');
INSERT INTO `user` VALUES ('1605010310', '1000000000', '系统管理员', '', '', '系统管理员');
